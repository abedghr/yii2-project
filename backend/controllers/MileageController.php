...
use backend\controllers\BaseControllers\MileageController as BaseControllersMileageController;
use Yii;
use common\models\Mileage;
use common\models\MileageSearch;
 ...
 */
class MileageController extends BaseControllersMileageController
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Displays a single Mileage model.
     * @param integer $id
     * @return mixed
